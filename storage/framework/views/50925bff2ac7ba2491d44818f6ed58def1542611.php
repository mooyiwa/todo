...
<br /> <?php echo e(session()->get('logged')); ?> <br /> </p>
      ...
      <?php if(session()->get('who') == 'user'): ?>
       ...
       <li <?php if($currentPage == 'post'): ?> id = 'here' <?php endif; ?>><a href="/user/post"><img src="<?php echo e(URL::asset('img/go.png')); ?>" /> Upload Song /Track </a></li>
       <li <?php if($currentPage == 'posts' || $currentPage == 'edit'): ?> id = 'here' <?php endif; ?>><a href="/user/posts"><img src="<?php echo e(URL::asset('img/sales.png')); ?>" /> All Tracks </a></li>
